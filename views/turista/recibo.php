...
.recibo-header { text-align: center; border-bottom: 2px solid #2563eb; padding-bottom: 1rem; margin-bottom: 1rem; }
.recibo-header h1 { color: #2563eb; margin: 0; }
...
.btn-imprimir { background: #2563eb; color: white; border: none; padding: 0.8rem 2rem; border-radius: 40px; font-weight: 600; cursor: pointer; margin-top: 1rem; }
...
<div class="recibo-container">
    ...
    <div style="text-align: center;">
        ...
        <a href="?view=mis_reservas" class="btn-volver">⬅ Volver</a>
    </div>
</div>